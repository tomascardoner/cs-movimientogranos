...
Begin VB.Form frmFormularioRT_Lista 
   ...
   EndProperty
   Icon            =   "FormularioRT_Lista.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ScaleHeight     =   5820
   ...
   Begin TrueOleDBGrid80.TDBGrid tdbgrdData 
      ...
      Columns(2).Caption=   "Certificado Origen"
      Columns(2).DataField=   "Origen_FormularioTipoNumero"
      ...
      Columns(4).ValueItems(0).Value=   "R"
      Columns(4).ValueItems(0).Value.vt=   8
      Columns(4).ValueItems(0).DisplayValue=   "Retiro"
      ...
      Columns(4).ValueItems(1).Value=   "T"
      Columns(4).ValueItems(1).Value.vt=   8
      Columns(4).ValueItems(1).DisplayValue=   "Transferencia"
      ...
      Columns(4).DataField=   "RetiroOTransferencia"
      ...
      Columns(6).Caption=   "Depositante"
      Columns(6).DataField=   "DepositanteRazonSocial"
      Columns(6)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(7)._VlistStyle=   0
      Columns(7)._MaxComboItems=   5
      Columns(7).Caption=   "Receptor"
      Columns(7).DataField=   "ReceptorRazonSocial"
      Columns(7)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(8)._VlistStyle=   0
      Columns(8)._MaxComboItems=   5
      Columns(8).Caption=   "Total Kgs."
      Columns(8).DataField=   "TotalKilogramo"
      ...
      Splits(0)._ColumnProps(16)=   "Column(2).Width=2302"
      Splits(0)._ColumnProps(17)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(18)=   "Column(2)._WidthInPix=2223"
      ...
      Splits(0)._ColumnProps(30)=   "Column(4).Width=2117"
      Splits(0)._ColumnProps(31)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(32)=   "Column(4)._WidthInPix=2037"
      ...
      Splits(0)._ColumnProps(37)=   "Column(5).Width=2117"
      Splits(0)._ColumnProps(38)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(39)=   "Column(5)._WidthInPix=2037"
      ...
      Splits(0)._ColumnProps(44)=   "Column(6).Width=4577"
      Splits(0)._ColumnProps(45)=   "Column(6).DividerColor=0"
      Splits(0)._ColumnProps(46)=   "Column(6)._WidthInPix=4498"
      ...
      Splits(0)._ColumnProps(51)=   "Column(7).Width=4577"
      Splits(0)._ColumnProps(52)=   "Column(7).DividerColor=0"
      Splits(0)._ColumnProps(53)=   "Column(7)._WidthInPix=4498"
      Splits(0)._ColumnProps(54)=   "Column(7)._EditAlways=0"
      Splits(0)._ColumnProps(55)=   "Column(7)._ColStyle=512"
      Splits(0)._ColumnProps(56)=   "Column(7).AllowFocus=0"
      Splits(0)._ColumnProps(57)=   "Column(7).Order=8"
      Splits(0)._ColumnProps(58)=   "Column(8).Width=1402"
      Splits(0)._ColumnProps(59)=   "Column(8).DividerColor=0"
      Splits(0)._ColumnProps(60)=   "Column(8)._WidthInPix=1323"
      ...
      _StyleDefs(52)  =   "Splits(0).Columns(4).Style:id=54,.parent=13,.alignment=2,.locked=-1"
      ...
      _StyleDefs(57)  =   "Splits(0).Columns(5).HeadingStyle:id=63,.parent=14,.alignment=2"
      ...
      _StyleDefs(64)  =   "Splits(0).Columns(7).Style:id=58,.parent=13,.alignment=0"
      ...
      _StyleDefs(68)  =   "Splits(0).Columns(8).Style:id=62,.parent=13,.alignment=1,.locked=-1"
   ...
   Begin ComCtl3.CoolBar cbrMain 
      ...
      Begin VB.PictureBox picFecha 
         ...
         Begin VB.CommandButton cmdFechaDesdeAnterior 
            Height          =   315
            Left            =   1680
            Picture         =   "FormularioRT_Lista.frx":0CCA
            Style           =   1  'Graphical
            TabIndex        =   11
            TabStop         =   0   'False
         ...
         Begin VB.CommandButton cmdFechaDesdeSiguiente 
            Height          =   315
            Left            =   3420
            Picture         =   "FormularioRT_Lista.frx":1254
            Style           =   1  'Graphical
            TabIndex        =   14
            TabStop         =   0   'False
         ...
         Begin VB.CommandButton cmdFechaDesdeHoy 
            Height          =   315
            Left            =   3720
            Picture         =   "FormularioRT_Lista.frx":17DE
            Style           =   1  'Graphical
            TabIndex        =   15
            TabStop         =   0   'False
            ToolTipText     =   "Hoy"
         ...
         Begin VB.CommandButton cmdFechaHastaAnterior 
            Height          =   315
            Left            =   4320
            Picture         =   "FormularioRT_Lista.frx":1928
            Style           =   1  'Graphical
            TabIndex        =   17
            TabStop         =   0   'False
            ToolTipText     =   "Anterior"
         ...
         Begin VB.CommandButton cmdFechaHastaSiguiente 
            Height          =   315
            Left            =   6060
            Picture         =   "FormularioRT_Lista.frx":1EB2
            Style           =   1  'Graphical
            TabIndex        =   19
            TabStop         =   0   'False
            ToolTipText     =   "Siguiente"
         ...
         Begin VB.CommandButton cmdFechaHastaHoy 
            Height          =   315
            Left            =   6360
            Picture         =   "FormularioRT_Lista.frx":243C
            Style           =   1  'Graphical
            TabIndex        =   20
            TabStop         =   0   'False
            ToolTipText     =   "Hoy"
   ...
   End
End
Attribute VB_Name = "frmFormularioRT_Lista"
...
Private Const REPORT_FILENAME_PREFIX As String = "Certificado RT - "
...
Public Function LoadData(ByVal IDFormulario1116RT As Long) As Boolean
    ...
    If IDFormulario1116RT = 0 Then
        If Not tdbgrdData.EOF Then
            SaveIDFormulario1116RT = tdbgrdData.Columns("IDFormulario1116RT").Value
        End If
    Else
    ...
    strSQLSelect = "SELECT Formulario1116RT_Cabecera.IDFormulario1116RT, Formulario1116RT_Cabecera.FormularioNumero, dbo.udf_GetFormulario1116TipoNumero(Formulario1116RT_Cabecera.Origen_FormularioTipo, Formulario1116RT_Cabecera.Origen_FormularioNumero) AS Origen_FormularioTipoNumero, Formulario1116RT_Cabecera.Fecha, Formulario1116RT_Cabecera.RetiroOTransferencia, Cereal.Nombre AS Cereal, Formulario1116RT_Cabecera.DepositanteRazonSocial, Formulario1116RT_Cabecera.ReceptorRazonSocial, Formulario1116RT_Cabecera.TotalKilogramo" & vbCr
    
    strSQLFrom = "FROM Formulario1116RT_Cabecera INNER JOIN Cereal ON Formulario1116RT_Cabecera.IDCereal = Cereal.IDCereal" & vbCr
    ...
    If cboPlanta.ListIndex > 0 Then
        strSQLWhere = strSQLWhere & IIf(strSQLWhere = "", "WHERE ", " AND ") & "Formulario1116RT_Cabecera.DepositarioIDEntidad = " & Left(CStr(cboPlanta.ItemData(cboPlanta.ListIndex)), Len(CStr(cboPlanta.ItemData(cboPlanta.ListIndex))) - 5) & " AND Formulario1116RT_Cabecera.DepositarioIDPlanta = " & Right(CStr(cboPlanta.ItemData(cboPlanta.ListIndex)), 5)
        mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116RT_Cabecera.DepositarioIDEntidad} = " & Left(CStr(cboPlanta.ItemData(cboPlanta.ListIndex)), Len(CStr(cboPlanta.ItemData(cboPlanta.ListIndex))) - 5) & " AND {Formulario1116RT_Cabecera.DepositarioIDPlanta} = " & Right(CStr(cboPlanta.ItemData(cboPlanta.ListIndex)), 5)
    End If
        
    'ENTIDAD
    If cboEntidad.ListIndex > 0 Then
        strSQLWhere = strSQLWhere & IIf(strSQLWhere = "", "WHERE ", " AND ") & "Formulario1116RT_Cabecera.DepositanteIDEntidad = " & cboEntidad.ItemData(cboEntidad.ListIndex)
        mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116RT_Cabecera.DepositanteIDEntidad} = " & cboEntidad.ItemData(cboEntidad.ListIndex)
    End If
        
    'COSECHA
    If cboCosecha.ListIndex > 0 Then
        strSQLWhere = strSQLWhere & IIf(strSQLWhere = "", "WHERE ", " AND ") & "Formulario1116RT_Cabecera.IDCosecha = " & cboCosecha.ItemData(cboCosecha.ListIndex)
        mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116RT_Cabecera.IDCosecha} = " & cboCosecha.ItemData(cboCosecha.ListIndex)
    End If
    
    'CEREAL
    If cboCereal.ListIndex > 0 Then
        strSQLWhere = strSQLWhere & IIf(strSQLWhere = "", "WHERE ", " AND ") & "Formulario1116RT_Cabecera.IDCereal = " & cboCereal.ItemData(cboCereal.ListIndex)
        mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116RT_Cabecera.IDCereal} = " & cboCereal.ItemData(cboCereal.ListIndex)
    End If
    ...
    Select Case cboFecha.ListIndex
        Case 0  'ALL
        Case 1  'EQUAL
            strSQLWhere = strSQLWhere & IIf(strSQLWhere = "", "WHERE ", " AND ") & "Formulario1116RT_Cabecera.Fecha = '" & Format(dtpFechaDesde.Value, "yyyy/mm/dd") & "'"
            mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116RT_Cabecera.Fecha} >= CDateTime(" & Format(dtpFechaDesde.Value, "yyyy, mm, dd") & ", 0, 0, 0) AND {Formulario1116A_Cabecera.Fecha} <= CDateTime(" & Format(dtpFechaDesde.Value, "yyyy, mm, dd") & ", 23, 59, 59)"
        Case 2  'GREATER
            ...
            mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116RT_Cabecera.Fecha} > CDateTime(" & Format(dtpFechaDesde.Value, "yyyy, mm, dd") & ", 23, 59, 59)"
        Case 3  'GREATER OR EQUAL
            ...
            mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116RT_Cabecera.Fecha} >= CDateTime(" & Format(dtpFechaDesde.Value, "yyyy, mm, dd") & ", 0, 0, 0)"
        Case 4  'MINOR
            strSQLWhere = strSQLWhere & IIf(strSQLWhere = "", "WHERE ", " AND ") & "Formulario1116RT_Cabecera.Fecha < '" & Format(dtpFechaDesde.Value, "yyyy/mm/dd") & " 00:00:00'"
            mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116RT_Cabecera.Fecha} < CDateTime(" & Format(dtpFechaDesde.Value, "yyyy, mm, dd") & ", 0, 0, 0)"
        ...
        Case 7  'BETWEEN
            ...
            mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116RT_Cabecera.Fecha} >= CDateTime(" & Format(dtpFechaDesde.Value, "yyyy, mm, dd") & ", 0, 0, 0) AND {Formulario1116RT_Cabecera.Fecha} <= CDateTime(" & Format(dtpFechaHasta.Value, "yyyy, mm, dd") & ", 23, 59, 59)"
    End Select
    ...
    Select Case RecordCount
        Case 0
            stbMain.SimpleText = "No hay Certificados de Retiro / Transferencia."
        Case 1
            stbMain.SimpleText = "1 Certificado de Retiro / Transferencia."
        Case Else
            stbMain.SimpleText = RecordCount & " Certificados de Retiro / Transferencia."
    End Select
...
ErrorHandler:
    ShowErrorMessage "Forms.FormularioRT_Lista.LoadData", "Error al leer la Lista de Certificados de Retiro / Transferencia."
    On Error Resume Next
    recData.Close
    Set recData = Nothing
End Function
...
'            Set Formulario1116A_Cabecera = Nothing
        ...
        Case "DELETE"
            If tdbgrdData.FirstRow = "" Then
                MsgBox "No hay ningún Certificado de Retiro / Transferencia seleccionado para eliminar.", vbExclamation, App.Title
                tdbgrdData.SetFocus
                Exit Sub
            End If
        
            If MsgBox("¿Desea eliminar el Certificado de Retiro / Transferencia?", vbExclamation + vbYesNo + vbDefaultButton2) = vbYes Then
                Set Formulario1116RT_Cabecera = New F1116RT_Cabecera
                Formulario1116RT_Cabecera.IDFormulario1116RT = tdbgrdData.Columns("IDFormulario1116RT").Value
                Call Formulario1116RT_Cabecera.Delete
...
Private Sub tlbMain_ButtonMenuClick(ByVal ButtonMenu As MSComctlLib.ButtonMenu)
    ...
    Select Case ButtonMenu.Parent.Key
        Case "NEW"
            Set Formulario1116RT_Cabecera = New F1116RT_Cabecera
            Formulario1116RT_Cabecera.RetiroOTransferencia = ButtonMenu.Key
            If frmFormularioRT_Detalle.Startup(Formulario1116RT_Cabecera) Then
...
'                End If
                frmFormularioRT_Detalle.Show
                frmFormularioRT_Detalle.SetFocus
            Else
                Unload frmFormularioRT_Detalle
        ...
        Case "PRINT"
            Select Case ButtonMenu.Key
                ...
                Case Else   'REPORTES DE FORMULARIOS
                    If tdbgrdData.FirstRow = "" Then
                        MsgBox "No hay ningún Certificado de Retiro / Transferencia seleccionado para imprimir.", vbExclamation, App.Title
                        tdbgrdData.SetFocus
                        Exit Sub
                    End If
                    ...
                    With Report
                        ...
                        .WindowTitle = ButtonMenu.Text & " - Certificado de Retiro / Transferencia Nº " & tdbgrdData.Columns("FormularioNumero").Value
                        .ParameterAdd("@IDFormulario1116RT", "", csrpdtNumberInteger, False, False, True).ParameterValue = tdbgrdData.Columns("IDFormulario1116RT").Value
