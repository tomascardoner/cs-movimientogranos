...
Begin VB.Form frmFormularioA_Lista 
   ...
   EndProperty
   Icon            =   "FormularioA_Lista.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ScaleHeight     =   5820
   ...
   Begin TrueOleDBGrid80.TDBGrid tdbgrdData 
      ...
      Columns(3).Caption=   "Cosecha"
      Columns(3).DataField=   "Cosecha"
      ...
      Splits(0)._ColumnProps(37)=   "Column(5).Width=3519"
      Splits(0)._ColumnProps(38)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(39)=   "Column(5)._WidthInPix=3440"
      ...
      Splits(0)._ColumnProps(44)=   "Column(6).Width=2117"
      Splits(0)._ColumnProps(45)=   "Column(6).DividerColor=0"
      Splits(0)._ColumnProps(46)=   "Column(6)._WidthInPix=2037"
      ...
      _StyleDefs(48)  =   "Splits(0).Columns(3).Style:id=28,.parent=13,.alignment=3,.locked=-1"
      ...
      _StyleDefs(56)  =   "Splits(0).Columns(5).Style:id=82,.parent=13,.alignment=2,.locked=-1"
      ...
      _StyleDefs(60)  =   "Splits(0).Columns(6).Style:id=50,.parent=13,.alignment=1,.locked=-1"
   ...
   Begin ComCtl3.CoolBar cbrMain 
      ...
      Begin VB.PictureBox picFecha 
         ...
         Begin VB.CommandButton cmdFechaDesdeAnterior 
            Height          =   315
            Left            =   1680
            Picture         =   "FormularioA_Lista.frx":0CCA
            Style           =   1  'Graphical
            TabIndex        =   8
            TabStop         =   0   'False
         ...
         Begin VB.CommandButton cmdFechaDesdeSiguiente 
            Height          =   315
            Left            =   3420
            Picture         =   "FormularioA_Lista.frx":1254
            Style           =   1  'Graphical
            TabIndex        =   11
            TabStop         =   0   'False
         ...
         Begin VB.CommandButton cmdFechaDesdeHoy 
            Height          =   315
            Left            =   3720
            Picture         =   "FormularioA_Lista.frx":17DE
            Style           =   1  'Graphical
            TabIndex        =   12
            TabStop         =   0   'False
            ToolTipText     =   "Hoy"
         ...
         Begin VB.CommandButton cmdFechaHastaAnterior 
            Height          =   315
            Left            =   4320
            Picture         =   "FormularioA_Lista.frx":1928
            Style           =   1  'Graphical
            TabIndex        =   14
            TabStop         =   0   'False
            ToolTipText     =   "Anterior"
         ...
         Begin VB.CommandButton cmdFechaHastaSiguiente 
            Height          =   315
            Left            =   6060
            Picture         =   "FormularioA_Lista.frx":1EB2
            Style           =   1  'Graphical
            TabIndex        =   16
            TabStop         =   0   'False
            ToolTipText     =   "Siguiente"
         ...
         Begin VB.CommandButton cmdFechaHastaHoy 
            Height          =   315
            Left            =   6360
            Picture         =   "FormularioA_Lista.frx":243C
            Style           =   1  'Graphical
            TabIndex        =   17
            TabStop         =   0   'False
            ToolTipText     =   "Hoy"
   ...
   End
End
Attribute VB_Name = "frmFormularioA_Lista"
...
Private Const REPORT_FILENAME_PREFIX As String = "Certificado de Depósito - "
...
Public Function LoadData(ByVal IDFormulario1116A As Long) As Boolean
    ...
    If IDFormulario1116A = 0 Then
        If Not tdbgrdData.EOF Then
            SaveIDFormulario1116A = tdbgrdData.Columns("IDFormulario1116A").Value
        End If
    Else
    ...
    strSQLSelect = "SELECT Formulario1116A_Cabecera.IDFormulario1116A, Formulario1116A_Cabecera.FormularioNumero, Formulario1116A_Cabecera.DepositanteRazonSocial, Cosecha.Nombre AS Cosecha, Cereal.Nombre AS Cereal, Formulario1116A_Cabecera.Fecha, Formulario1116A_Cabecera.PesoNeto" & vbCr
    
    strSQLFrom = "FROM (Formulario1116A_Cabecera INNER JOIN Cosecha ON Formulario1116A_Cabecera.IDCosecha = Cosecha.IDCosecha) INNER JOIN Cereal ON Formulario1116A_Cabecera.IDCereal = Cereal.IDCereal" & vbCr
    ...
    If cboPlanta.ListIndex > 0 Then
        strSQLWhere = strSQLWhere & IIf(strSQLWhere = "", "WHERE ", " AND ") & "Formulario1116A_Cabecera.DepositarioIDEntidad = " & Left(CStr(cboPlanta.ItemData(cboPlanta.ListIndex)), Len(CStr(cboPlanta.ItemData(cboPlanta.ListIndex))) - 5) & " AND Formulario1116A_Cabecera.DepositarioIDPlanta = " & Right(CStr(cboPlanta.ItemData(cboPlanta.ListIndex)), 5)
        mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116A_Cabecera.DepositarioIDEntidad} = " & Left(CStr(cboPlanta.ItemData(cboPlanta.ListIndex)), Len(CStr(cboPlanta.ItemData(cboPlanta.ListIndex))) - 5) & " AND {Formulario1116A_Cabecera.DepositarioIDPlanta} = " & Right(CStr(cboPlanta.ItemData(cboPlanta.ListIndex)), 5)
    End If
    ...
    If cboEntidad.ListIndex > 0 Then
        ...
        mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116A_Cabecera.DepositanteIDEntidad} = " & cboEntidad.ItemData(cboEntidad.ListIndex)
    End If
    
    'COSECHA
    If cboCosecha.ListIndex > 0 Then
        strSQLWhere = strSQLWhere & IIf(strSQLWhere = "", "WHERE ", " AND ") & "Formulario1116A_Cabecera.IDCosecha = " & cboCosecha.ItemData(cboCosecha.ListIndex)
        mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116A_Cabecera.IDCosecha} = " & cboCosecha.ItemData(cboCosecha.ListIndex)
    End If
    ...
    If cboCereal.ListIndex > 0 Then
        ...
        mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116A_Cabecera.IDCereal} = " & cboCereal.ItemData(cboCereal.ListIndex)
    End If
    ...
    Select Case cboFecha.ListIndex
        Case 0  'ALL
        Case 1  'EQUAL
            strSQLWhere = strSQLWhere & IIf(strSQLWhere = "", "WHERE ", " AND ") & "Formulario1116A_Cabecera.Fecha = '" & Format(dtpFechaDesde.Value, "yyyy/mm/dd") & "'"
            mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116A_Cabecera.Fecha} >= CDateTime(" & Format(dtpFechaDesde.Value, "yyyy, mm, dd") & ", 0, 0, 0) AND {Formulario1116A_Cabecera.Fecha} <= CDateTime(" & Format(dtpFechaDesde.Value, "yyyy, mm, dd") & ", 23, 59, 59)"
        Case 2  'GREATER
            ...
            mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116A_Cabecera.Fecha} > CDateTime(" & Format(dtpFechaDesde.Value, "yyyy, mm, dd") & ", 23, 59, 59)"
        Case 3  'GREATER OR EQUAL
            ...
            mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116A_Cabecera.Fecha} >= CDateTime(" & Format(dtpFechaDesde.Value, "yyyy, mm, dd") & ", 0, 0, 0)"
        Case 4  'MINOR
            strSQLWhere = strSQLWhere & IIf(strSQLWhere = "", "WHERE ", " AND ") & "Formulario1116A_Cabecera.Fecha < '" & Format(dtpFechaDesde.Value, "yyyy/mm/dd") & " 00:00:00'"
            mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116A_Cabecera.Fecha} < CDateTime(" & Format(dtpFechaDesde.Value, "yyyy, mm, dd") & ", 0, 0, 0)"
        ...
        Case 7  'BETWEEN
            ...
            mRecordSelectionFormula = mRecordSelectionFormula & IIf(mRecordSelectionFormula = "", "", " AND ") & "{Formulario1116A_Cabecera.Fecha} >= CDateTime(" & Format(dtpFechaDesde.Value, "yyyy, mm, dd") & ", 0, 0, 0) AND {Formulario1116A_Cabecera.Fecha} <= CDateTime(" & Format(dtpFechaHasta.Value, "yyyy, mm, dd") & ", 23, 59, 59)"
    End Select
    ...
    Select Case RecordCount
        Case 0
            stbMain.SimpleText = "No hay Certificados de Depósito."
        Case 1
            stbMain.SimpleText = "1 Certificado de Depósito."
        Case Else
            stbMain.SimpleText = RecordCount & " Certificados de Depósito."
    End Select
...
ErrorHandler:
    ShowErrorMessage "Forms.FormularioA_Lista.LoadData", "Error al leer la Lista de Certificados de Depósito."
    On Error Resume Next
    recData.Close
    Set recData = Nothing
End Function
...
'                MsgBox "No hay ningún Certificado de Depósito seleccionado para modificar.", vbExclamation, App.Title
'                tdbgrdData.SetFocus
'                Exit Sub
'            End If
'            Set Formulario1116A_Cabecera = New F1116A_Cabecera
...
'            Set Formulario1116A_Cabecera = Nothing
        ...
        Case "DELETE"
            If tdbgrdData.FirstRow = "" Then
                MsgBox "No hay ningún Certificado de Depósito seleccionado para eliminar.", vbExclamation, App.Title
                tdbgrdData.SetFocus
                Exit Sub
            End If
            
            If MsgBox("¿Desea eliminar el Certificado de Depósito?", vbExclamation + vbYesNo + vbDefaultButton2) = vbYes Then
                Set Formulario1116A_Cabecera = New F1116A_Cabecera
                Formulario1116A_Cabecera.IDFormulario1116A = tdbgrdData.Columns("IDFormulario1116A").Value
                Call Formulario1116A_Cabecera.Delete
                Set Formulario1116A_Cabecera = Nothing
            End If
        ...
        Case "PRINT"
            Select Case ButtonMenu.Key
                ...
                Case Else   'REPORTES DE FORMULARIOS
                    If tdbgrdData.FirstRow = "" Then
                        MsgBox "No hay ningún Certificado de Depósito seleccionado para imprimir.", vbExclamation, App.Title
                        tdbgrdData.SetFocus
                        Exit Sub
                    End If
                    ...
                    With Report
                        ...
                        .WindowTitle = ButtonMenu.Text & " - Certificado de Depósito Nº " & tdbgrdData.Columns("FormularioNumero").Value
                        .ParameterAdd("@IDFormulario1116A", "", csrpdtNumberInteger, False, False, True).ParameterValue = tdbgrdData.Columns(0).Value
