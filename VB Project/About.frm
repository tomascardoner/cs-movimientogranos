...
Begin VB.Form frmAbout 
   ...
   Begin VB.Label lblWeb 
      Caption         =   "www.cardonersistemas.com.ar"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
      ...
      Height          =   195
      Left            =   3180
      MouseIcon       =   "About.frx":19DD
      MousePointer    =   99  'Custom
      TabIndex        =   8
      Top             =   2340
      Width           =   2475
   End
   Begin VB.Label lblEmailLabel 
      Caption         =   " E-mail:"
      Height          =   195
      Left            =   2520
      TabIndex        =   5
   ...
   Begin VB.Label lblCredits 
      Alignment       =   2  'Center
      Caption         =   "Este Sistema ha sido desarrollado por Tomás A. Cardoner."
      Height          =   255
      Left            =   960
      TabIndex        =   3
      Top             =   660
...
Private Sub lblEmail_Click()
    CSM_Internet.OpenAddress Me.hwnd, "mailto:" & lblEmail.Caption
End Sub

Private Sub lblWeb_Click()
    CSM_Internet.OpenAddress Me.hwnd, "http://" & lblWeb.Caption
End Sub
