...
Public Function FillComboBox_Rubrica() As Boolean
    ...
    If cboPlanta.ListIndex > -1 Then
        ...
        Call CSM_Control_ComboBox.FillFromSQL(cboRubrica, "usp_LibroMovimiento_List 0, 1, 1, " & CSM_Control_ComboBox.GetSubID(cboPlanta, 5, 1) & ", " & CSM_Control_ComboBox.GetSubID(cboPlanta, 5, 2) & ", NULL", "Rubrica", "Nombre", "Rúbricas", cscpItemOrFirst, SaveItemData, False)
    End If
End Function
...
Private Function LibroMovimiento_Generar(ByVal IDEntidad As Long, ByVal IDPlanta As Integer, ByVal Rubrica As Long, ByVal PeriodoMes As Byte, PeriodoAnio As Integer) As Boolean
    ...
    '/////////////////////////////////////////////
    'EMPIEZO A GENERAR POR EL PRIMER DÍA DEL MES
    Folio = Folio + 1
    Linea = 1
    
    'GENERO LA LÍNEA CON EL SALDO DEL FOLIO ANTERIOR
    ...
    'VOY ITERANDO DÍA POR DÍA Y RECORRIENDO LOS REGISTROS
        ...
        Do While Not recData.EOF
            Select Case Day(recData("Fecha").Value)
                ...
                Case Is = DiaActual
                    ...
                    'ERA LA ÚLTIMA LÍNEA, HAY QUE TOMAR EL SALDO, PASAR A OTRO FOLIO Y CREAR LA LÍNEA DE SALDO ANTERIOR
